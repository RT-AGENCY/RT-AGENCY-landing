...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'Благодаря Performance Agency мы смогли снизить стоимость привлечения клиента на 37% и увеличить конверсию сайта почти в 2 раза. Отличная работа и постоянное сопровождение!',
    date: 'Апрель 2025',
  },
  {
    name: 'Анна Соколова',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Специалисты Performance Agency помогли нам с запуском нового направления. Четко выстроенная стратегия, креативные решения и постоянная оптимизация рекламных кампаний принесли отличные результаты.',
    date: 'Январь 2025',
  },
];
